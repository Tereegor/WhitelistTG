...
- `bukkit/target/whitelist-bukkit-1.1.1.jar`
- `velocity/target/whitelist-velocity-1.1.1.jar`

### Размещение файлов

| Файл | Назначение |
|------|------------|
| `whitelist-bukkit-1.1.1.jar` | Директория `plugins/` серверов Paper/Spigot |
| `whitelist-velocity-1.1.1.jar` | Директория `plugins/` прокси Velocity |

> **Важно:** Файл `whitelist-common-1.1.1.jar` размещать не требуется — он автоматически включён в состав bukkit и velocity модулей.
